 ...
 * </copyright>
 *
 * $Id: WidgetsFactoryImpl.java,v 1.3 2010/03/18 10:23:25 htraetteb Exp $
 */
...
public class WidgetsFactoryImpl extends EFactoryImpl implements WidgetsFactory {
	...
	public static WidgetsFactory init() {
		try {
			WidgetsFactory theWidgetsFactory = (WidgetsFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/plugin/org.eclipse.e4.tm/model/swt/widgets.ecore"); 
