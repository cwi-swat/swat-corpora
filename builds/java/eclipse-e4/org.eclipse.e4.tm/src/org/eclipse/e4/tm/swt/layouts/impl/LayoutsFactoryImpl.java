 ...
 * </copyright>
 *
 * $Id: LayoutsFactoryImpl.java,v 1.4 2010/03/18 10:23:25 htraetteb Exp $
 */
...
public class LayoutsFactoryImpl extends EFactoryImpl implements LayoutsFactory {
	...
	public static LayoutsFactory init() {
		try {
			LayoutsFactory theLayoutsFactory = (LayoutsFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/plugin/org.eclipse.e4.tm/model/swt/layouts.ecore"); 
