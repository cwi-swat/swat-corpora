 ...
 * </copyright>
 *
 * $Id: WidgetsSwitch.java,v 1.3 2010/03/18 10:23:25 htraetteb Exp $
 */
...
import org.eclipse.e4.tm.swt.widgets.*;
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WidgetsPackage.SLIDER: {
				...
				if (result == null) result = caseBoundedValueControl(slider);
				if (result == null) result = caseControl(slider);
				if (result == null) result = caseObjectData(slider);
				if (result == null) result = caseStyled(slider);
				if (result == null) result = caseScripted(slider);
			...
			case WidgetsPackage.SPINNER: {
				...
				if (result == null) result = caseBoundedValueControl(spinner);
				if (result == null) result = caseControl(spinner);
				if (result == null) result = caseObjectData(spinner);
				if (result == null) result = caseStyled(spinner);
				if (result == null) result = caseScripted(spinner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WidgetsPackage.SCALE: {
				...
				if (result == null) result = caseBoundedValueControl(scale);
				if (result == null) result = caseControl(scale);
				if (result == null) result = caseObjectData(scale);
				if (result == null) result = caseStyled(scale);
				if (result == null) result = caseScripted(scale);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
