 ...
 * </copyright>
 *
 * $Id: StylesSwitch.java,v 1.3 2009/08/27 08:55:35 htraetteb Exp $
 */
...
public class StylesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StylesPackage.STYLE_SELECTOR: {
			...
			case StylesPackage.COLOR_ITEM: {
				ColorItem colorItem = (ColorItem)theEObject;
				T result = caseColorItem(colorItem);
				if (result == null) result = caseStyleItem(colorItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StylesPackage.IMAGE_ITEM: {
				ImageItem imageItem = (ImageItem)theEObject;
				T result = caseImageItem(imageItem);
				if (result == null) result = caseStyleItem(imageItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StylesPackage.FONT_ITEM: {
				FontItem fontItem = (FontItem)theEObject;
				T result = caseFontItem(fontItem);
				if (result == null) result = caseStyleItem(fontItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Color Item</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Color Item</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColorItem(ColorItem object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Font Item</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Font Item</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFontItem(FontItem object) {
		return null;
	}
